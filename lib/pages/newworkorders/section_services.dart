              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    SizedBox(
                      width: 220,
                      child: _labelValue('Carrier', carrier),
                    ),
                    SizedBox(
                      width: 180,
                      child: _labelValue('Flight', flightNumber),
                    ),
                    SizedBox(
                      width: 180,
                      child: _labelValue(
                        'Aircraft',
                        aircraftType.isEmpty ? 'Not specified' : aircraftType,
                      ),
                    ),
                    SizedBox(
                      width: 160,
                      child: _labelValue('Gate', gate.isEmpty ? 'TBD' : gate),
                    ),
                  ],
                ),
                const SizedBox(height: 12),
