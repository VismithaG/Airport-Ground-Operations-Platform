                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: DropdownButtonFormField<String>(
                        initialValue: aircraftType.isEmpty
                            ? null
                            : aircraftType,
                        decoration: const InputDecoration(
                        ...
                        items: const [
                          DropdownMenuItem(
                            value: 'A320',
                            child: Text('Airbus A320'),
                          ),
                          DropdownMenuItem(
                            value: 'A330',
                            child: Text('Airbus A330'),
                          ),
                          DropdownMenuItem(
                            value: 'A350',
                            child: Text('Airbus A350'),
                          ),
                          DropdownMenuItem(
                            value: 'A380',
                            child: Text('Airbus A380'),
                          ),
                          DropdownMenuItem(
                            value: 'B737',
                          ...
                          DropdownMenuItem(
                            value: 'B777',
                            child: Text('Boeing 777'),
                          ),
                          DropdownMenuItem(
                            value: 'B787',
                            child: Text('Boeing 787'),
                          ),
                        ],
                      ),
                    ),
                      ...
                      child: DropdownButtonFormField<String>(
                        ...
                        items: const [
                          DropdownMenuItem(
                            ...
                            child: Text('Ground Operations'),
                          ),
                          DropdownMenuItem(
                            value: 'Passenger Services',
                            child: Text('Passenger Services'),
                          ),
                          DropdownMenuItem(
                            value: 'Ramp Services',
                            child: Text('Ramp Services'),
                          ),
                          DropdownMenuItem(
                            value: 'Cargo Operations',
                            child: Text('Cargo Operations'),
                          ),
                          DropdownMenuItem(
                            value: 'Maintenance',
                    ...
                    SizedBox(
                      ...
                      child: DropdownButtonFormField<String>(
                        ...
                        items: const [
                          DropdownMenuItem(
                            value: 'Low',
                            child: Text('Low - Standard processing'),
                          ),
                          DropdownMenuItem(
                            value: 'Medium',
                            child: Text('Medium - Expedited'),
                          ),
                          DropdownMenuItem(
                            value: 'High',
