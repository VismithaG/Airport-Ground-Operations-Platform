...
import 'create_work_order_page.dart'; // Import your existing create page
...
class _WorkOrdersListPageState extends State<WorkOrdersListPage> {
  // Mock Data to match Section 1.png
  final List<WorkOrder> _workOrders = [
    WorkOrder(
      ...
      services: [
        'Unaccompanied Minor/Young...(2)',
        'VIP or any other person v...(1)'
      ],
      quantities: {},
      notes: '',
    ),
